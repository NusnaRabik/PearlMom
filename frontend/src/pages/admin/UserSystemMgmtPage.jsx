...
const UserSystemMgmtPage = () => {
  ...
  const permissionMatrix = [
    { action: 'Edit Users', admin: true, provider: true, mother: true },
    ...
    <div className="p-6 space-y-6 min-h-screen pb-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 mt-1">Managing 1,284 maternal records and system integrity.</p>
        </div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <div className="relative flex-1">
            ...
            <input
              ...
              placeholder="Search by Mother ID, Name, or Email"
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              ...
              <button className={`relative w-12 h-6 rounded-full transition-colors ${
                systemSettings.maintenanceMode ? 'bg-pink-500' : 'bg-gray-300'
              }`}>
                <div className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow transition-transform ${
                  systemSettings.maintenanceMode ? 'left-6' : 'left-0.5'
                }`}></div>
              </button>
            </div>
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div>
                ...
                <p className="text-xs text-gray-500">Daily snapshots</p>
              </div>
              <button className={`relative w-12 h-6 rounded-full transition-colors ${
                systemSettings.autoBackup ? 'bg-pink-500' : 'bg-gray-300'
              }`}>
                <div className={`absolute top-0.5 w-5 h-5 bg-white rounded-full shadow transition-transform ${
                  systemSettings.autoBackup ? 'left-6' : 'left-0.5'
                }`}></div>
              </button>
            </div>
            <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
              <div>
                ...
                <p className="text-xs text-gray-500">Default {systemSettings.sessionTimeout} mins</p>
              </div>
          ...
          <div className="bg-white rounded-xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <button
                      ...
                      className="p-6 border-2 border-gray-200 rounded-xl hover:border-pink-300 hover:bg-pink-50 transition-all text-center group"
                    >
                    ...
                    <button
                      onClick={() => handleSelectUserType('nurse')}
                      className="p-6 border-2 border-gray-200 rounded-xl hover:border-pink-300 hover:bg-pink-50 transition-all text-center group"
                    >
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="e.g., m.webb@maternal.sys"
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-pink-500 focus:border-pink-500"
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          type="text"
                          value={providerForm.designation}
                          onChange={(e) => setProviderForm({...providerForm, designation: e.target.value})}
                      ...
                      <div>
                        ...
                        <input
                          type="text"
                          value={providerForm.clinic}
                          onChange={(e) => setProviderForm({...providerForm, clinic: e.target.value})}
                    ...
                    <div>
                      ...
                      <input
                        type="tel"
                        value={providerForm.emergencyContact}
                        onChange={(e) => setProviderForm({...providerForm, emergencyContact: e.target.value})}
                        placeholder="e.g., +1 (555) 999-8877"
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-pink-500 focus:border-pink-500"
                      />
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="e.g., s.chen@maternal.sys"
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-pink-500 focus:border-pink-500"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        placeholder="e.g., Consultant Obstetrician"
                        className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-pink-500 focus:border-pink-500"
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          type="tel"
                          value={doctorForm.emergencyContact}
                          onChange={(e) => setDoctorForm({...doctorForm, emergencyContact: e.target.value})}
                          placeholder="e.g., +1 (555) 888-7766"
                          className="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-pink-500 focus:border-pink-500"
                        />
                      </div>
                    </div>
            ...
            {!addUserSuccess && selectedUserType && (
              <div className="flex items-center justify-end space-x-3 p-6 border-t border-gray-200 bg-gray-50">
                ...
                <button
                  onClick={() => {
                    if (selectedUserType === 'provider') handleAddProvider();
                    else if (selectedUserType === 'nurse') handleAddDoctor();
